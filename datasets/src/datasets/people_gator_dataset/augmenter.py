"""
stolen and modified from: https://github.com/mk-minchul/AdaFace/blob/master/dataset/augmenter.py (TODO proper crediting)
"""
...
class Augmenter:
    ...
    def augment(self, sample):
        ...
        elif self.augType == AugmentationType.PhotocentricAug:
