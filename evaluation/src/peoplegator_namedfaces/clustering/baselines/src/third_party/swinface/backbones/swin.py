...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=112, patch_size=2, in_chans=3, num_classes=1000,
        ...
        self.feature_resolution = (patches_resolution[0] // (
            2 ** (self.num_layers-1)), patches_resolution[1] // (2 ** (self.num_layers-1)))
    ...
    def forward_features(self, x):
        ...
        global_features = global_features.transpose(1, 2).reshape(
            B, C, self.feature_resolution[0], self.feature_resolution[1])
        # B, C, H, W
